...
public class ConnectController extends GridPane implements Initializable {
    ...
    private void connect() {
        ...
        try {
            port.openPort();
            //paypaytr hanged 20.14 - 4 eylul sanirim
            //BURASI 57600 SABIT OLUCAK
            port.setParams(57600, dataBits.getValue(), stopBits.getValue().getBits(), parity.getValue().getParity());
