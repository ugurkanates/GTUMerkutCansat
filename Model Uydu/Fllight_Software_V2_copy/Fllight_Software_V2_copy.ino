 ...
 *
 * Pin usage: A0:BATT A1:SER1 A2:SER2 A3:SER3 13:BMP 12:BMP 11:BMP 10:BMP 6:XBEE 5:XBEE 4:GPS 3:GPS
 */
...
const int SERVO3 = A3;
//Xbee Connections
#define XBEE_RX 5 //Receives from Xbee
#define XBEE_TX 6
...
void setup()
{
  ...
  Serial.println("Starting up CANSAT...");
}
...
String PrepareFeed ()
{
  ...
  //EXAMPLE: <7893,00001,2018.09.17/16:50:07,100919.67,432.1,07.2,29.3,7.4,43.12345,21.12345,430.9,08>
